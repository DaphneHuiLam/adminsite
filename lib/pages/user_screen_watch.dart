// lib/pages/user_screen_watch.dart
...
class UserScreenWatch extends StatefulWidget {
  @override
  _UserScreenWatchState createState() => _UserScreenWatchState();
}

class _UserScreenWatchState extends State<UserScreenWatch> {
